        ...
        <div className="container mx-auto px-6">
          ...
          <div className="flex items-center justify-between h-20 mt-4 px-6">
            ...
            <div className="flex items-center space-x-4">
              <Link
                to="/login"
                className="text-white hover:text-yellow-400 transition-all duration-300 text-sm font-medium px-4 py-2 rounded-lg hover:bg-white/10"
              >
                Sign In
              </Link>
              <Link
                to="/signup"
                className="bg-yellow-500/90 hover:bg-yellow-400 text-navy-900 px-6 py-2 rounded-lg text-sm font-semibold transition-all duration-300 border border-yellow-400/20 hover:shadow-lg hover:shadow-yellow-500/25"
              >
                Sign up
              </Link>
            </div>
      ...
      <main className="container mx-auto px-6 pt-16 pb-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <Link
              to="/signup"
              className="bg-yellow-500/90 hover:bg-yellow-400 text-navy-900 px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300 shadow-xl border border-yellow-400/20 hover:shadow-2xl hover:shadow-yellow-500/30 hover:scale-105"
            >
              Start Monitoring Your Assets
            </Link>
            <Link
              to="/login"
              className="border-2 border-white/30 text-white hover:bg-white/10 hover:border-white/50 px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300 hover:shadow-lg hover:scale-105"
            >
