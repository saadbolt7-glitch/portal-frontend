          ...
          <div className="mx-auto w-full max-w-md text-center">
            ...
            <div className="space-y-4 mb-8">
              <button
                ...
                className="w-full bg-yellow-500 text-navy-900 py-3 px-4 rounded-lg font-semibold hover:bg-yellow-400 transition-colors"
              >
                Send another email
              </button>
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-white">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              your password and get you back to monitoring your flow measurement systems 
              in no time.
            </p>
          </div>
